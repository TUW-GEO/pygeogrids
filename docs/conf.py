...
module_dir = os.path.join(__location__, "../src/pygeogrids")
try:
...
try:
    from pygeogrids import __version__ as version
except ImportError:
    pass
else:
    release = version
...
latex_documents = [
    ("index", "user_guide.tex", "pygeogrids Documentation", "TU Wien", "manual")
]
